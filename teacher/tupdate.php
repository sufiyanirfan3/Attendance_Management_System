<?php
    include '../db_connection.php';
        ...
        $update="UPDATE teacher SET teacher_name='{$eteacher_name}',teacher_image='$eteacher_image',password='{$epassword}', email='{$eemail}',phone='{$ephone}',address='$eaddress' WHERE teacher_id={$teacher_id}";
